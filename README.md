...
1. 下载地址：https://github.com/GyanD/codexffmpeg/releases/download/8.1/ffmpeg-8.1-full_build.zip
...
本项目应用图标为自主设计的简化麦克风图标（白色麦克风 + 青色圆形背景）。

设计风格参考自 Tabler Icons（MIT 许可证）的麦克风图标，不直接使用其图标文件，仅参考其设计理念。
